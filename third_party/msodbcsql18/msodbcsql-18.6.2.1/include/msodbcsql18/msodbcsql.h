...
#define SQLODBC_VER 1800
#endif

#if SQLODBC_VER >= 1800

#define SQLODBC_PRODUCT_NAME_FULL_VER_ANSI      "Microsoft ODBC Driver 18 for SQL Server"
#define SQLODBC_PRODUCT_NAME_FULL_ANSI          "Microsoft ODBC Driver for SQL Server"
#define SQLODBC_PRODUCT_NAME_SHORT_VER_ANSI     "ODBC Driver 18 for SQL Server"

#define SQLODBC_PRODUCT_NAME_SHORT_ANSI         "ODBC Driver for SQL Server"

#endif /* SQLODBC_VER >= 1800 */
...
#define SQL_C_SS_VECTOR                        (SQL_C_TYPES_EXTENDED+2)
...
typedef enum
    {
    SQL_VECTOR_TYPE_FLOAT32 = 0, // 32-bit floating point, Later more types can be added
    } 	SQLVECTORTYPE;
...
typedef struct tagSS_VECTOR_STRUCT
{
        ...
        SQLVECTORTYPE type;     // Type indicator, e.g., 0 for float32 (other value for float16 in future) 
        union data
        {
